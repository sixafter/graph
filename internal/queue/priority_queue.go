...
var (
	// ErrStackEmpty is returned when an attempt is made to Dequeue or access the Top
...
//	pq.Enqueue("task1", 2.0)
//	pq.Enqueue("task2", 1.0)
//	task, err := pq.Dequeue()
//	if err != nil {
//	    fmt.Println(err)
//	} else {
...
//	pq.Enqueue("task1", 2.0)
//	pq.Enqueue("task2", 1.0)
func (p *PriorityQueue[T]) Enqueue(item T, priority float64) {
...
// Dequeue removes and returns the item with the lowest priority from the priority queue.
